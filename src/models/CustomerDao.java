...
public class CustomerDao {
    ...
    public List listCustomerQuery(String value) {
        ...
        try {
            ...
            //recorrer los registros de los clientes
            while (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al listar los clientes de la farmacia" + e.toString());
        }
    ...
    public boolean updateCustomerQuery(Customers customer) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error en la modificación de la información del cliente" + e);
            return false;
        }
    }
    ...
    public boolean deleteCustomerQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Error al eliminar el cliente con id = "+id+ "tiene relación en otra tabla");
            return false;
        }
    }
}
